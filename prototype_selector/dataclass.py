...
class Data:
    def __init__(self, model_name, train_table_path, train_summary_path, train_context_path, test_table_path, 
        ...
        # print(self.train_all_candidate_text_list)
        # print(self.train_summary_text_list)
    ...
    def get_next_train_batch(self, batch_size):
        ...
        # one data in the batch: table, summary, candi * train_neg_num
        ...
        # first process reference data: table + reference (concat)
