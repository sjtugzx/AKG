...
def parse_config():
    ...
    parser.add_argument('--add_content', type=str, default='True', help="whether include highlight content in the generator input.")
    ...
    parser.add_argument("--knowledge_adapter_path", type=str, )
...
if __name__ == '__main__':
    ...
    train_content_path = args.dataset_prefix + '/train_content.txt'
    dev_content_path = args.dataset_prefix + '/dev_content.txt'
    ...
    assert args.add_content in ['True', 'False']
    if args.add_content == 'True':
        add_content = True
    else:
        add_content = False

    data = Data(train_table_path, train_summary_path, train_context_path, train_content_path,
                args.train_data_num, dev_table_path, dev_summary_path, dev_context_path, dev_content_path,
                args.max_table_len, args.max_tgt_len, args.max_context_len, args.context_num, args.max_content_len,
                args.model_name, add_context=add_context, add_content=add_content)
    print('Data loaded.')
