...
class T5Gen_Model(nn.Module):
	...
	def save_adapter_fusion(self, save_directory: str, adapter_names, meta_dict: dict = None,
		...
		self.model.save_adapter_fusion(save_directory, adapter_names, meta_dict,
									   custom_weights_loaders, with_head)
	...
	def load_adapter(self, adapter_name_or_path: str, config = None, version:
	str = None, model_name: str = None, load_as: str = None, source: str = None, with_head: bool
	= True, custom_weights_loaders = None, leave_out = None, id2label=None,
					 set_active: bool = False, **kwargs):
		return self.model.load_adapter(adapter_name_or_path, config, version, model_name, load_as,
								  source, with_head, custom_weights_loaders, leave_out, id2label,
									   set_active, **kwargs)
